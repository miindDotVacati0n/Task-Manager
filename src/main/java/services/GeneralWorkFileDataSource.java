...
public class GeneralWorkFileDataSource implements DataSource {
    ...
    public void readData() throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (data[0].equals("GeneralWork")){
                model.works.GeneralWorks generalWork = new model.works.GeneralWorks(data[1].trim(), data[2].trim(), data[3].trim(), data[4].trim(), data[5].trim(), data[6].trim(), data[7].trim());
    ...
    public void setData(DataList list) {
        ...
        try {
            ...
            for (GeneralWorks work : list.getGeneralWorkArrayList()) {
